...
const TargetQuestionIMBModal: React.FC<IProps> = ({
  ...
  return (
    <div className='action-modal'>
      ...
      <h2 className='action-modal__title'>It's My Birthday!</h2>
      <div className='money'>
        {money.map((card) => {
          switch (getType(card)) {
            case 'PropertyCard':
      ...
      <div className='modal--card__button-container'>
        ...
        <button
          onClick={() =>
            socket.emit(SocketEvent.FROM_CLIENT_TARGET_RESPONSE_IMB, { cardIds: cardIds })
          }
...
export default TargetQuestionIMBModal;
