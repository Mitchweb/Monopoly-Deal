...
const TargetQuestionRentModal: React.FC<IProps> = ({
  ...
  return (
    <div className='action-modal'>
      ...
      <div className='modal--card__button-container'>
        ...
        <button
          onClick={() =>
            socket.emit(SocketEvent.FROM_CLIENT_TARGET_RESPONSE_RENT, { cardIds: cardIds })
          }
...
export default TargetQuestionRentModal;
