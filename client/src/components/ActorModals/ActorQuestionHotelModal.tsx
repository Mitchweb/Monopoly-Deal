...
const ActorQuestionHotelModal: React.FC<IProps> = ({ socket, cardId, hand, validSets }) => {
  const [selectedSet, setSelectedSet] = useState<number>(validSets[0]);
  ...
  return (
    <div className='action-modal'>
      ...
      <h2 className='action-modal__title'>Hotel</h2>
      ...
      <div className='modal--card__button-container'>
        <button
          onClick={() =>
            socket.emit(SocketEvent.FROM_CLIENT_ACTOR_RESPONSE_HOTEL, { selectedSet: selectedSet })
          }
...
export default ActorQuestionHotelModal;
